...
class MissManners:
    ...
    def ask(self, message, *args):
        ...
        action = message.replace(magic_word, '', 1)
        # str.replace(str_old, str_new, max_time_of_replacement)
        # or: attr = message[len(magic_word):], so brilliant!
